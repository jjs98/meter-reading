...
@Component({
  selector: 'app-new-reading-dialog',
  standalone: true,
  imports: [
    ButtonModule,
    CalendarModule,
  ...
  templateUrl: './new-reading-dialog.component.html',
  styleUrl: './new-reading-dialog.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class NewReadingDialogComponent {
